...
import br.edu.thiago.dao.ClientDAO;
...
public class ClientServlet extends HttpServlet {
	...
	private void updateClient(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		Client clint = new Client(id, registration, modality, name, district, city, cep, state, publicPlace, cellphone);
	...
	private void insertClient(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		Client client = new Client(registration, modality, name, district, city, cep, state, publicPlace, cellphone);
